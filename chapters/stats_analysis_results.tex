...
Example category mass fit plots are shown in Figures X-Y and the full set of mass fits is shown in Appendix Z. 
...
The effect of using the DCNN-based VBF Tag over the BDT-based tag on category signnificances is shown in Table \ref{tab:stats_results:sig_table}.
...
\end{equation}
where $\hat{\mu}$, $\hat{m}_{H}$ and $\hat{n}$ are the best fit values for the signal strength modifier, Higgs mass and nuissance parameters respectively. 
The parameters $\mu$, $\hat{m}_{H,\mu}$ and $\vec{n}_{\mu}$ are the global signal strength being profiled in the likelihood scan, the Higgs mass allowed to float for a given value of $\mu$, and the nuissance paramter values also allowed to float. 
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/stats_results/Figure_015.pdf}
    \end{center}
    \caption{Likelihood scan of the global signal strength modifier $\mu$ with a $-2\Delta{\mathrm{NLL}}$ test statistic.}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/stats_results/Figure_016.pdf}
    \end{center}
    \caption{Likelihood scan results of the prodction mode signal strength modifiers $\mu$ with a $-2\Delta{\mathrm{NLL}}$ test statistic.}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.6\textwidth]{figures/stats_results/Figure_017.pdf}
    \end{center}
    \caption{SM prediction to measured cross section ratios in the SXTS stage 0 framework.}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.6\textwidth]{figures/stats_results/Figure_018.pdf}
    \end{center}
    \caption{Two-dimensional likelihood scan of signal strength modifiers for bosonic (VBF, VH) and fermionic (ggH, \ttH) production modes.}
...
These differences are measures with two 2D likelihood scans 
